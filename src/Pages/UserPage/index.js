...
import { getUserData, updateUserData } from "../../Redux/ApiCalls/user/auth";
import { getUser } from "../../Redux/Reducers/user/userData";
import { Dropdown, Menu, Space } from "antd";
import Loader from "../../Components/Loader";
import CoursesPage from "./userAction/Courses";
import Courses from "./action/Courses";
          ...
          <div className="content">
            <div className="content_header">
              <div className="left">
                ...
                <div className="nav_link">
                  ...
                  <NavLink to={`/user/${id}/allcourses`}>Courses</NavLink>
                </div>
              </div>
            ...
            <div className="content_body">
              ...
              <div className="right ">
                <Switch>
                  <Route
                    path={`/user/${id}/mycourses`}
                    component={CoursesPage}
                  />
                  <Route path={`/user/${id}/allcourses`} component={Courses} />
                  <Redirect to={`/user/${id}/mycourses`} />
                </Switch>
              </div>
            </div>
          </div>
